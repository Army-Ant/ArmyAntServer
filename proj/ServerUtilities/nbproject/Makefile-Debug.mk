...
${OBJECTDIR}/_ext/9e673e4/SqlRequest.pb.o: nbproject/Makefile-${CND_CONF}.mk ../../res/ProtobufSource/cpp/ArmyAntMessage/DBProxy/SqlRequest.pb.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DDEBUG -DOS_Linux -D_64BIT -D_DEBUG -D_cplusplus -D_x86 -I../../inc -I../../external/ArmyAntLib/inc -I../../external/mysql/mysql-connector-c++-8.0.11/include -I../../external/Protobuf/inc -I../../res/ProtobufSource/cpp -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/9e673e4/SqlRequest.pb.o ../../res/ProtobufSource/cpp/ArmyAntMessage/DBProxy/SqlRequest.pb.cc
...
${OBJECTDIR}/_ext/35c7a07b/SessionStart.pb.o: nbproject/Makefile-${CND_CONF}.mk ../../res/ProtobufSource/cpp/ArmyAntMessage/System/SessionStart.pb.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DDEBUG -DOS_Linux -D_64BIT -D_DEBUG -D_cplusplus -D_x86 -I../../inc -I../../external/ArmyAntLib/inc -I../../external/mysql/mysql-connector-c++-8.0.11/include -I../../external/Protobuf/inc -I../../res/ProtobufSource/cpp -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/35c7a07b/SessionStart.pb.o ../../res/ProtobufSource/cpp/ArmyAntMessage/System/SessionStart.pb.cc
...
${OBJECTDIR}/_ext/35c7a07b/SocketHead.pb.o: nbproject/Makefile-${CND_CONF}.mk ../../res/ProtobufSource/cpp/ArmyAntMessage/System/SocketHead.pb.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/35c7a07b
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DDEBUG -DOS_Linux -D_64BIT -D_DEBUG -D_cplusplus -D_x86 -I../../inc -I../../external/ArmyAntLib/inc -I../../external/mysql/mysql-connector-c++-8.0.11/include -I../../external/Protobuf/inc -I../../res/ProtobufSource/cpp -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/35c7a07b/SocketHead.pb.o ../../res/ProtobufSource/cpp/ArmyAntMessage/System/SocketHead.pb.cc
